...
import { stringToUint8Array, uint8ArrayToBytes, uint8ArrayToString } from "../utils";
...
export class PhantasmaKeys implements IKeyPair {
    ...
    constructor(privateKey: Uint8Array) {
        ...
        this._publicKey = stringToUint8Array(ed25519.keyFromSecret(uint8ArrayToString(this._privateKey)).getPublic("hex"));
    ...
    public Sign(msg: Uint8Array, customSignFunction?: (msg: Uint8Array, privateKey: Uint8Array, publicKey: Uint8Array) => Uint8Array): Signature {
